    ...
    <section className="section about-page">
      ...
      <div className="about-section">
        ...
        <div className="about-section-heading">
          ...
          <p className="about-eyebrow">
            {aboutCurrently.eyebrow}
          </p>

          <h2>
            {aboutCurrently.title}
          </h2>
        ...
        <div className="about-current-grid">
          ...
          {aboutCurrently.items.map((item) => (
            ...
            <div
              className="about-current-card"
              key={item.title}
            >

              <span className="about-current-icon">
                {item.icon}
              </span>

              <div>

                <span className="about-current-label">
                  {item.label}
                </span>
      ...
      <div className="about-section about-more">
        ...
        <div className="about-more-grid">
          ...
          <div className="about-more-card">
            ...
            <span>
              {aboutBeyondEngineering.interestsLabel}
            </span>
